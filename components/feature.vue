    ...
    <div class="max-w-6xl mx-auto py-20 font-[sans-serif]">
        ...
        <div class="grid gap-12 lg:grid-cols-3 md:grid-cols-2">
            <div class="text-center">
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Customization</h3>
                <p class="text-sm text-gray-600">Tailor our product to suit your needs Tailor our product to suit your
                    needs.</p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Security</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Support</h3>
                <p class="text-sm text-gray-600">Tailor our product to suit your needs 24/7 customer support for all
                    your inquiries.</p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Performance</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Global Reach</h3>
                <p class="text-sm text-gray-600">Tailor our product to suit your needs Expand your reach with our global
                    network.</p>
            </div>
            ...
            <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="inline-block w-8 mb-6"
                    ...
                    <g fill="none" stroke="#007bff" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)"
                        transform="matrix(1.33 0 0 -1.33 0 682.667)">
                        <path
                ...
                <h3 class="mb-3 text-xl font-semibold text-gray-800">Communication</h3>
                <p class="text-sm text-gray-600">Tailor our product to suit your needs Seamless communication for your
                    team.</p>
            </div>
        </div>
    </div>
